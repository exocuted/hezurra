...
*/
	...
	$meta_boxes['portada'] = array(
		'id'      => 'portada',
		'title'   => __( 'Portada', 'cmb' ),
		'show_on' => array( 'key' => 'slug', 'value' => 'portada' ),
		'pages'      => array( 'page', ),
		'fields'  => array(
			array(
				'name' => __( 'Imatge cap', 'cmb' ),
				'desc' => __( 'Upload an image or enter a URL.', 'cmb' ),
				'id'   => $prefix . 'imatge_cap',
				'type' => 'file',
			),
			array(
				'name' => __( 'Titol cap', 'cmb' ),
				'desc' => __( 'Titol del cap.', 'cmb' ),
				'id'   => $prefix . 'titol_cap',
				'type' => 'text',
			),
			array(
				'name' => __( 'Descripcio cap', 'cmb' ),
				'desc' => __( 'Descripcio del cap.', 'cmb' ),
				'id'   => $prefix . 'textarea_cap',
				'type' => 'textarea',
			),
			array(
				'name' => __( 'Text boto', 'cmb' ),
				'desc' => __( 'Text del boto.', 'cmb' ),
				'id'   => $prefix . 'text_boto_cap',
				'type' => 'text',
			),
			array(
				'name' => __( 'Link boto', 'cmb' ),
				'desc' => __( 'link del boto.', 'cmb' ),
				'id'   => $prefix . 'link_boto_cap',
				'type' => 'text',
			),
		)
	);
